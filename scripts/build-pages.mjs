      ...
      <section id="community-panel" class="community-widget-panel" hidden aria-label="Floating chat helper">
        <div class="community-widget-header" id="community-drag-handle">
          <div class="community-widget-title">
            ...
            <span>A tiny helper for thoughts, writing, and board questions.</span>
          </div>
        ...
        <div class="community-widget-body">
          ...
          <form id="community-form" class="community-widget-form">
            <textarea id="community-input" class="community-widget-input" placeholder="Ask a quick question..." maxlength="1000"></textarea>
            <div class="community-widget-actions">
              <div id="community-status" class="community-widget-status">Ask for a quick thought or a little help writing something.</div>
  ...
  <script>
    (function () {
      ...
      function openCommunityWidget() {
        ...
        setCommunityStatus(communityHistory.length ? "Ask another quick question." : "Ask for a quick thought or a little help writing something.");
        if (communityInput) {
      ...
      function closeCommunityWidget() {
        ...
        setCommunityStatus("Ask for a quick thought or a little help writing something.");
      }
