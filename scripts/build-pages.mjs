...
<head>
  ...
  <style>
    :root {
      ...
      --shadow: 0 30px 80px rgba(22, 54, 31, 0.13);
    }
    ...
    * { box-sizing: border-box; }
    ...
    body {
      ...
      background:
        radial-gradient(circle at 9% 0%, rgba(122, 176, 106, 0.24), transparent 27%),
        radial-gradient(circle at 86% 8%, rgba(63, 159, 153, 0.18), transparent 24%),
        radial-gradient(circle at 100% 38%, rgba(212, 162, 69, 0.16), transparent 28%),
        linear-gradient(180deg, #fbfaf3 0%, var(--bg-2) 45%, var(--bg) 100%);
      min-height: 100vh;
      overflow-x: hidden;
    }
    body::before {
      ...
      pointer-events: none;
      background-image:
        linear-gradient(rgba(17, 26, 20, 0.035) 1px, transparent 1px),
        linear-gradient(90deg, rgba(17, 26, 20, 0.035) 1px, transparent 1px);
    ...
    body::after {
      ...
      pointer-events: none;
      background:
        radial-gradient(circle, rgba(63, 159, 153, 0.15), transparent 64%),
        radial-gradient(circle at 34% 34%, rgba(183, 92, 109, 0.12), transparent 58%);
      z-index: -1;
    }
    ...
    .panel {
      background:
        linear-gradient(180deg, rgba(255,255,255,0.88), rgba(249,250,244,0.78)),
        radial-gradient(circle at 100% 0%, rgba(63,159,153,0.12), transparent 32%);
    ...
    .hero::before {
      ...
      right: -120px;
      top: -90px;
      background: radial-gradient(circle, rgba(63, 159, 153, 0.2), transparent 68%);
    }
    .hero::after {
      width: 230px;
      height: 230px;
      left: -110px;
      bottom: -120px;
      background: radial-gradient(circle, rgba(212, 162, 69, 0.18), transparent 70%);
    }
    .eyebrow {
      display: inline-flex;
      align-items: center;
    ...
    .eyebrow::before {
      ...
      box-shadow: 0 0 0 6px rgba(63, 159, 153, 0.12);
    }
    .hero h1 {
      margin: 16px 0 0;
      font-family: "Outfit", Arial, sans-serif;
      ...
      max-width: 10.5ch;
      background: linear-gradient(135deg, #0b1d12 0%, #173f26 52%, #3f8b57 100%);
    ...
    .community-pulse-card {
      ...
      background:
        ...
        radial-gradient(circle at 86% 0%, rgba(63,159,153,0.14), transparent 54%);
      border: 1px solid rgba(16,32,21,0.08);
      box-shadow: 0 14px 28px rgba(17, 38, 22, 0.07);
    }
    .community-pulse-card strong {
      display: block;
      font-family: "Outfit", Arial, sans-serif;
      font-size: 24px;
      line-height: 1;
    ...
    .board::before {
      ...
      pointer-events: none;
      background:
        radial-gradient(circle at 80% 0%, rgba(212,162,69,0.16), transparent 30%),
        radial-gradient(circle at 0% 100%, rgba(63,159,153,0.12), transparent 32%);
    }
    .board > * {
      position: relative;
    }
    ...
    .button-primary {
      background: linear-gradient(135deg, var(--green) 0%, var(--green-2) 72%, var(--teal) 100%);
      color: #fffdf7;
      box-shadow: 0 16px 32px rgba(47, 122, 68, 0.26);
    }
    .button-secondary {
    ...
    .detail-body-preview.is-truncated::after {
      content: "";
      position: absolute;
      left: 0;
      right: 0;
      ...
      pointer-events: none;
      background: linear-gradient(180deg, rgba(247,249,243,0), rgba(247,249,243,0.98));
    }
    .reader-more {
      margin-top: 12px;
      border-radius: 18px;
    ...
    .reader-more summary {
      ...
      font-weight: 900;
      color: var(--green-deep);
      background: linear-gradient(135deg, rgba(45, 111, 64, 0.08), rgba(226, 186, 107, 0.12));
    }
    ...
    .reader-more[open] summary::after { content: " -"; }
    .reader-more .detail-body {
      margin: 0;
      border: 0;
      border-top: 1px solid rgba(16, 32, 21, 0.08);
      border-radius: 0;
    ...
    @media (max-width: 760px) {
      .johnny-site-nav { width: min(100vw - 12px, 680px); }
      .page { width: min(100vw - 12px, 680px); padding: 12px 0 28px; }
    ...
    /* 618chat visual refresh */
    body {
      -webkit-font-smoothing: antialiased;
      text-rendering: geometricPrecision;
      background:
        radial-gradient(circle at 12% -8%, rgba(87, 142, 93, 0.28), transparent 32%),
        radial-gradient(circle at 88% 3%, rgba(69, 161, 153, 0.2), transparent 28%),
        radial-gradient(circle at 55% 110%, rgba(215, 161, 76, 0.22), transparent 34%),
    ...
    .johnny-site-nav {
      ...
      box-shadow: 0 24px 70px rgba(21, 48, 29, 0.12);
    }
    .johnny-site-brand {
      display: inline-flex;
      align-items: center;
    ...
    .johnny-site-brand::before {
      ...
      height: 12px;
      border-radius: 999px;
      background: radial-gradient(circle, #58d49a 0 38%, #1e7042 42% 100%);
      box-shadow: 0 0 0 7px rgba(45, 111, 64, 0.1), 0 0 24px rgba(63, 159, 153, 0.34);
    }
    .johnny-site-link {
      min-height: 40px;
      padding: 0 16px;
      background: rgba(255,255,255,0.52);
      border-color: rgba(16, 32, 21, 0.06);
    }
    .page {
      width: min(1460px, calc(100vw - 28px));
      padding-top: 16px;
    ...
    .panel {
      border-color: rgba(16, 32, 21, 0.075);
      box-shadow: 0 30px 90px rgba(22, 54, 31, 0.14);
    }
    .hero {
      position: sticky;
      top: 98px;
      color: #fffdf7;
      background:
        radial-gradient(circle at 88% 7%, rgba(242, 190, 91, 0.26), transparent 34%),
        radial-gradient(circle at 5% 92%, rgba(81, 195, 170, 0.2), transparent 36%),
        linear-gradient(145deg, #102317 0%, #173d26 55%, #0d1f16 100%);
      border-color: rgba(255,255,255,0.18);
      box-shadow: 0 34px 90px rgba(12, 35, 20, 0.26);
    }
    .hero::before {
      background:
        linear-gradient(135deg, rgba(255,255,255,0.12) 0 10%, transparent 10% 100%),
    ...
    .board {
      ...
      border-radius: 34px;
      background:
        linear-gradient(180deg, rgba(255,255,255,0.92), rgba(249,250,243,0.86)),
        radial-gradient(circle at 94% 0%, rgba(63,159,153,0.14), transparent 32%);
    }
    .board-top h2 {
    ...
    .filter-drawer[open] summary::after { content: "Close"; }
    .filter-drawer .board-toolbar {
      margin-top: 0;
      border: 0;
      border-top: 1px solid rgba(16,32,21,0.08);
      border-radius: 0;
    ...
    .reader {
      background:
        linear-gradient(180deg, rgba(255,255,255,0.92), rgba(246,250,244,0.88)),
        radial-gradient(circle at 100% 0%, rgba(45,111,64,0.08), transparent 30%);
    }
    .spotlight {
      border-radius: 26px;
      background:
        radial-gradient(circle at 90% 0%, rgba(212,162,69,0.22), transparent 35%),
        linear-gradient(135deg, rgba(23,68,37,0.95), rgba(18,45,31,0.96));
      border-color: rgba(255,255,255,0.16);
      color: #fffdf7;
      box-shadow: 0 22px 55px rgba(23, 68, 37, 0.18);
    }
    .spotlight h4,
    .spotlight-card h5 {
      color: #fffdf7;
...
${chatSiteNav("home")}
  <main class="page">
    <section class="intro">
      <div class="panel hero">
        ...
        <p>
          A public board for saying the thing that is hard to say elsewhere. Write anonymously, read slowly, and keep the room human.
        </p>
        <div class="pill-row">
        ...
        <div class="hero-stat-row" aria-label="How 618chat works">
          <div class="hero-stat"><strong>18+</strong><span>Adults-only conversation space</span></div>
          <div class="hero-stat"><strong>No login</strong><span>Use a nickname or stay anonymous</span></div>
          <div class="hero-stat"><strong>Kind first</strong><span>Support, reply, or flag with care</span></div>
        </div>
        <div class="community-pulse-grid" aria-label="618chat principles">
          <div class="community-pulse-card">
            <strong>Private first</strong>
            <span>Use a nickname or stay anonymous. Keep identifying details off the board.</span>
          </div>
          <div class="community-pulse-card">
            <strong>Real replies</strong>
            <span>Read, support, reply, and keep the conversation human.</span>
          </div>
          <div class="community-pulse-card">
            <strong>Gentle rules</strong>
            <span>Adults only, respectful tone, and moderation tools if something crosses the line.</span>
          </div>
        </div>
      ...
      <div class="panel board">
        <div class="board-top">
          <div>
            ...
            <p>Write a post, read what others are carrying, or reply with care. Long posts stay tucked behind read-more controls so the page stays easy to scan.</p>
          </div>
        ...
        <details class="filter-drawer">
          <summary>Search and filter conversations</summary>
        ...
        <div class="layout">
          <section class="composer" aria-label="New post" id="compose">
            <h3>Write anonymously</h3>
            <p>Say what is on your mind. 618chat will title it for the board, and you can stay anonymous if you want.</p>
            <form id="board-form">
          ...
          <section class="reader" aria-label="Selected post">
            ...
            <p>Choose a card below to open the preview, read more, support, or reply.</p>
        ...
        <div class="list" style="margin-top: 14px;" id="recent-posts">
          <div class="board-top" style="align-items: center;">
            <div>
              ...
              <p>Newest posts appear first. Long messages stay compact until someone chooses to read more.</p>
            </div>
            <div class="board-summary">
  ...
  <script>
    (function () {
      ...
      function getReaderPreview(value) {
        const full = formatDisplayedMessage(value);
        const paragraphs = full
          .split(/\\n\\s*\\n|\\n/)
          .map((paragraph) => paragraph.trim())
          .filter(Boolean);
        let preview = paragraphs[0] || full.trim();
        let truncated = paragraphs.length > 1;

        if (preview.length > readerPreviewLimit) {
          preview = preview
