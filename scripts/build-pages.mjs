...
function chatSiteNav(active) {
  ...
  <header class="johnny-site-nav">
    ...
    <nav class="johnny-site-links" aria-label="Site">
      ...
      <a class="johnny-site-link" href="#posts">Recent conversations</a>
    ...
    <section class="intro">
      <div class="panel hero">
        ...
        <div class="hero-actions">
          ...
          <a class="button button-secondary" href="#posts">Read conversations</a>
        </div>
    ...
    (function () {
      ...
      async function loadPosts() {
        ...
        try {
          ...
          loading = false;
          statusEl.textContent = posts.length ? "Conversation board loaded." : "No posts yet. Be the first to start a conversation.";
