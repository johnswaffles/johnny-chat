        ...
        <div class="layout">
          <section class="composer" aria-label="New post">
            ...
            <form id="board-form">
              ...
              <div class="hint">Posts are shared publicly with everyone who visits 618chat.</div>
            </form>
          </section>
  ...
  <script>
    (function () {
      ...
      async function loadPosts() {
        loading = true;
        statusEl.textContent = "Loading public posts...";
        try {
          ...
          loading = false;
          statusEl.textContent = posts.length ? "Public board loaded." : "No posts yet. Be the first to add one.";
      ...
      function renderPosts() {
        ...
        if (loading) {
          postsEl.innerHTML = '<div class="empty-state">Loading the public board...</div>';
          renderReader(null);
          return;
        }
      ...
      form.addEventListener("submit", (event) => {
        ...
        statusEl.textContent = "Posting to the public board...";
        statusEl.classList.remove("error");
        ...
        fetch(postsUrl, {
          ...
          .then(({ response, payload }) => {
            ...
            form.reset();
            statusEl.textContent = "Message added to the public board.";
            statusEl.classList.remove("error");
            render();
            messageInput.focus();
          })
