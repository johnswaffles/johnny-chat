import {effectIcon} from './status-icons.js?v=20260921-ascendancy1';
import { bearVariant } from './bear-variants.js?v=20260921-toolbarheal1';
import {UNIT_TYPES} from './config.js?v=20260921-ascendancy1';
import {unitStatuses,sigilSvg,FIRST_CONDEMNATION,displayedUnitHealth} from './unit-status.js?v=20260921-ascendancy1';
