...
import { CHARACTER_RIGS } from './character-rigs.js?v=20260921-startingroom1';
import {PAINTED_FIGHTER_TYPES} from './painted-roster-rig.js?v=20260921-startingroom1';
import { HEARTHKIN_RIG_ART } from './hearthkin-rig-art.js?v=20260909-cursedbears1';
import { COMBAT_ATLASES, UNIT_TYPES, VILLAGER_ATLASES } from './config.js?v=20260921-startingroom1';
