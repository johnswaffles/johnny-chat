import {isWardProtected} from './unit-status.js?v=20260920-guardmilitia1';
import {encounterOpenness} from './combat-teams.js?v=20260920-guardmilitia1';
import { BEAR_VARIANT_IDS, bearVariant } from './bear-variants.js?v=20260920-guardmilitia1';
import { CONFIG, UNIT_TYPES } from './config.js?v=20260920-guardmilitia1';
