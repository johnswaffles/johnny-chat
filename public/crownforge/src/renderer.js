import {drawStormDragons} from './storm-dragon-renderer.js?v=20260921-steadyhealers1';
import {drawWizardMagic} from './wizard-magic.js?v=20260921-steadyhealers1';
...
import {BlenderHearthkinRenderer} from './hearthkin-blender-renderer.js?v=20260921-steadyhealers1';
import {corpseLifetime} from './bear-combat.js?v=20260921-steadyhealers1';
import { ASHEN_HEARTHKIN_PAINTED_ART } from './ashen-hearthkin-painted-art.js?v=20260909-cursedbears1';
import { PaintedHearthkinRenderer } from './hearthkin-painted-renderer.js?v=20260921-steadyhealers1';
import {curseRuneKind,drawCurseSigil,displayedUnitHealth} from './unit-status.js?v=20260921-steadyhealers1';
import { GrizzlyRenderer } from './grizzly-renderer.js?v=20260921-steadyhealers1';
import {paintedRosterFactories} from './painted-roster-rig.js?v=20260921-steadyhealers1';
import { CHARACTER_RIGS, createCharacterRigs } from './character-rigs.js?v=20260921-steadyhealers1';
import { BUILDING_DEPTH } from './building-depth-data.js?v=20260921-steadyhealers1';
import { BUILDING_COMPONENTS } from './building-components-data.js?v=20260921-steadyhealers1';
import { hasBuildingOutline, buildingPolygon } from './building-geometry.js?v=20260921-steadyhealers1';
import { drawHearthkinWard } from './hearthkin-rig.js?v=20260911-blueward1';
import { CrownforgeLandscape } from './landscape.js?v=20260921-steadyhealers1';
import { ForestCache } from './forest-cache.js?v=20260921-steadyhealers1';
import { CrownforgeMeadow } from './meadow.js?v=20260921-steadyhealers1';
import { CrownforgeAtmosphere } from './atmosphere.js?v=20260921-steadyhealers1';
...
import { ANIMATION_EVENTS, animationDefinition, animationFrame, resolveAnimationState } from './animation.js?v=20260921-steadyhealers1';
...
export class CrownforgeRenderer {
  ...
  drawUnit(ctx, unit, time) {
    if(unit.type==='wizard'&&unit.eventideVeil>4.8&&!unit.dead)return;
    const point = this.unitScreenPoint(unit);
    const style = UNIT_TYPES[unit.type];
