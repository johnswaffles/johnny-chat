import { BUILDING_DEPTH } from './building-depth-data.js?v=20260921-steadyhealers1';
import { polygonBounds } from './building-geometry.js?v=20260921-steadyhealers1';
...
export const UNIT_TYPES = {
  wizard:{label:'Starveil Arcanist',asset:'soldier',renderSize:124,speed:2.1,acceleration:9,braking:12,radius:.44,maxHp:210,attack:36,range:36,cooldown:2.2,attackTiming:{anticipation:.35,contact:.25,recovery:.4},autoAggroRadius:23,combatRole:'damage',ranged:true,canAttackUnits:true,canAttackBuildings:false,sideLimit:1},
  grizzly: {
...
export const COMBAT_ATLASES = {
  ...
  raiderDeath: rosterAnimationAtlas('ashen-raider', 'death', 4),
  scout: {
  ...
  scoutWalk: rosterAnimationAtlas('crown-scout', 'walk', 3),
  scoutAttack: rosterAnimationAtlas('crown-scout', 'attack', 3),
  scoutDeath: rosterAnimationAtlas('crown-scout', 'death', 4),
  spearwarden: {
  ...
  shieldbearerWalk: rosterAnimationAtlas('crown-shieldbearer', 'walk', 3),
  shieldbearerAttack: rosterAnimationAtlas('crown-shieldbearer', 'attack', 3),
  shieldbearerDeath: rosterAnimationAtlas('crown-shieldbearer', 'death', 4),
  ashenForagerMotion: {
  ...
  ashenOutriderWalk: rosterAnimationAtlas('ashen-outrider', 'walk', 3),
