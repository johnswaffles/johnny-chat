...
24. **Dungeon architecture modular kit** — `192×192 px` transparent cells, orthographic 3/4 top-down: ancient wall cap, corner, four-way arch, pillar, stair, cracked lintel, and collapsed-stone edge. Supply 4 stone variants, 3 damage states, and separate highlight/occlusion layers. Used around every shrine room so the dungeon reads as built architecture instead of flat rectangles.
