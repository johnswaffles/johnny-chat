...
8. **NPC presentation set — ROWAN + TANSY + BRINDLE MOVEMENT COMPLETE** — `npcs/rowan-sheet-generated-v1.png` is integrated for Rowan’s idle, walk, map-work, talk, and reaction states; `npcs/tansy-fire-generated-v1.png` covers Tansy’s four-direction fire-side idle/stir loop; and `npcs/brindle-directional-walk-generated-v1.png` covers Brindle’s four-direction route movement. Lumen still uses the named/activity family for her map-work role loop; add a dedicated sheet only when directional review identifies a concrete mismatch. The Rowan and Tansy sheets remain the visual references for future NPC work.
