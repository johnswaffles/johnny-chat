...
| Rowan directional movement | `npcs/rowan-directional-walk-generated-v1.png` | 4 columns × 4 rows, 312×312 source cells, 16 frames | Dedicated down/up/left/right route-walk cycles with four sequential frames per direction; selected for Rowan's non-dialogue pacing and drawn at 58×76 with a `.94` feet anchor |
...
| Brindle directional movement | `npcs/brindle-directional-walk-generated-v1.png` | 4 columns × 4 rows, 312×312 source cells, 16 frames | Brindle down/up/left/right walk cycles with four sequential frames per direction; selected only during his non-dialogue pond route and drawn at 58×76 with a `.94` feet anchor |
...
8. **NPC presentation set — ROWAN + TANSY + LUMEN + BRINDLE MOVEMENT COMPLETE** — `npcs/rowan-sheet-generated-v1.png` is integrated for Rowan’s idle, walk, map-work, talk, and reaction states; `npcs/tansy-fire-generated-v1.png` covers Tansy’s four-direction fire-side idle/stir loop; `npcs/brindle-directional-walk-generated-v1.png` covers Brindle’s four-direction route movement; and `npcs/lumen-map-generated-v1.png` covers Lumen’s four-direction map-work loop. The trader remains portrait-only until a runtime spawn exists. Keep the four directional sheets as the NPC movement reference family.
