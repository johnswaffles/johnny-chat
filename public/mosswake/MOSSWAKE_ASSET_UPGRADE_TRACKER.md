...
- Bumped the runtime page cache key to `mosswake.js?v=51`. Local syntax, manifest/alpha checks, and a second live visual smoke are required to confirm the road reads as one continuous path without tile seams or excessive visual busyness.
