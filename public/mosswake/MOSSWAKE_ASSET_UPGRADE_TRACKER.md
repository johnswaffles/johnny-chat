...
- `node --check`, manifest/alpha validation, local startup/movement/attack smoke, and public `/mosswake/?qa=5f4835d` overworld smoke passed with no console warnings or errors.
