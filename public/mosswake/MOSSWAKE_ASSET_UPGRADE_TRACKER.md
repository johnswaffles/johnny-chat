...
- Fresh browser startup loaded `mosswake.js?v=83`, `manifest.json?v=46`, and the new atlas with HTTP 200. Focused Root Gallery and Heartseed Sanctum restores visibly show the generated plaques, statues, machines, medallions, Guardian HUD, and phase telegraph in-room. Sword, dash, and directional movement smoke produced no browser warning/error logs.
