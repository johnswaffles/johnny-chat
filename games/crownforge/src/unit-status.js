...
import {deathlessActive,updateDeathlessHeart,deathlessCrossingDamage} from './deathless-heart.js?v=20260913-mercy1';
import { bearVariant } from './bear-variants.js?v=20260913-mercy1';
import {UNIT_TYPES} from './config.js?v=20260913-mercy1';
import {bearCrowdMultiplier,BEAR_FURY,bearFuryActive,bearEnrageActive,isFighter} from './bear-combat.js?v=20260913-mercy1';
