...
export function unitStatuses(unit){
  ...
  if(bearEnrageActive(unit))statuses.push({id:'greatwoodColossus',name:'Greatwood Colossus',kind:'Enrage',detail:'50% true health · double size and damage',summary:'Wounded ancient blood awakens a towering guardian.',effect:'At half true health, doubles body size, collision radius, and damage for the rest of its life. Stacks with Wrath of the First Oath. Bloodclaw Reckoning sweeps within 14 units every 8 seconds: all hostile units take 25% maximum-health AoE damage before defenses.',rune:'fury',art:bearVariant(unit).art});
  if(bearEnrageActive(unit)||fury)statuses.push({id:'bloodclawReckoning',name:'Bloodclaw Reckoning',kind:'Area of effect',detail:'8-second cooldown · 25% maximum-health damage',summary:'Three crimson claws tear across the battle line.',effect:'Every hostile unit within 14 units and clear line of sight takes 25% of its maximum health as AoE damage before defenses. Hits in every direction, including tanks and healers. Ward protection is respected. Aegis of the Unbroken Crown reduces tank AoE damage by 90%, stacking with armor and Last Bastion.',rune:'fury',art:bearVariant(unit).art});
