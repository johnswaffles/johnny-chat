...
import { militaryActions, militaryPose, MILITARY_PROFILES } from './military-motion.js?v=20260921-architecture1';
import { mountedActions, mountedPose } from './mounted-motion.js?v=20260921-architecture1';
