...
import {startSidePull,sidePullPlan,combatRole,eligibleMember,TEAM_RULES} from './combat-teams.js?v=20260913-firstoath1';
export function createTeamControls(sim,onChange){
 ...
 function update(){
  ...
  panel.querySelector('[data-help]').textContent=`Every ${TEAM_RULES.healInterval}s, heal all injured allies within ${TEAM_RULES.healRange} yards (tanks: ${TEAM_RULES.healRange+5}): tanks +${TEAM_RULES.tankHealAmount} HP, others +${TEAM_RULES.healAmount}. Building orders pause healing until finished. Tanks lead; healers follow behind the damage line. Add as many units as you like.`;
 }
