import {isWardProtected} from './unit-status.js?v=20260923-livingearth1';
import {encounterOpenness} from './combat-teams.js?v=20260923-livingearth1';
import { BEAR_VARIANT_IDS, bearVariant } from './bear-variants.js?v=20260921-toolbarheal1';
import { CONFIG, UNIT_TYPES } from './config.js?v=20260923-livingearth1';
