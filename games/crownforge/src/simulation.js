import {grantFinalBenediction,updateFinalBenediction} from './final-benediction.js?v=20260923-firstage1';
import {wizardAttackRange,reckoningDamage} from './eventide-ascendancy.js?v=20260923-firstage1';
import {prepareWizardPosition} from './wizard-positioning.js?v=20260923-firstage1';
import {stormwardDamage} from './storm-dragon.js?v=20260923-firstage1';
import {castWizardSpell,updateWizardMagic,wizardIncomingDamage} from './wizard-magic.js?v=20260923-firstage1';
import {cancelSidePull,prepareTankPull,holdForTankPull,markFrontFallback,bearRearPosition,bearOrbitStep,combatRole,isTeamHealer,eligibleMember,TEAM_RULES,teams,assignTeam,leaveTeam,selectTeam,tankTarget,claimThreat,updateTeams,prepareTeamAttack,updateTeamApproaches,teamMovePoint} from './combat-teams.js?v=20260923-firstage1';
import { BEAR_VARIANT_IDS } from './bear-variants.js?v=20260923-firstage1';
import { kingsbaneMultiplier, updateGreatwoodDefiance, bearEnrageActive, combatRadius, inBearSwipe, BEAR_FURY, FIGHTER_PURSUIT, isFighter, bearFuryActive, bearArrowDamage, bearIncomingDamage, corpseLifetime } from './bear-combat.js?v=20260923-firstage1';
import {updateLastBastion,lastBastionDamage,isCurseImmune,isWardProtected,strikeDamage} from './unit-status.js?v=20260923-firstage1';
import { initialWildlifeState, updateWildlife } from './wildlife.js?v=20260923-firstage1';
import { GRIZZLY_PURSUIT, grizzlyAttackDefinition, updateGrizzlyMotion } from './grizzly-motion.js?v=20260923-firstage1';
import { assignEnemyEconomy, assignEnemyPatrols } from './enemy-routines.js?v=20260923-firstage1';
import { landscapeHash, landscapeNoise, woodlandDensity, woodlandRidgeZ, FOREST_LIMITS } from './landscape-layout.js?v=20260923-firstage1';
import { BUILDING_ART_VERSION } from './building-depth-data.js?v=20260923-firstage1';
import { readSavedGameForBuildingUpgrade } from './building-save-backup.js?v=20260923-firstage1';
import { hasBuildingOutline, buildingActorProfile, outlineBounds, outlineApproaches, distanceToOutline, withinOutlineDistance, projectOutsideOutline, cellIntersectsOutline, translatedOutline, polygonsOverlap } from './building-geometry.js?v=20260923-firstage1';
import { BUILDING_TYPES, CONFIG, ENEMY_AI, FACTION, FIRST_AGE_BUILD_BLUEPRINTS, FIRST_AGE_MILESTONES, FIRST_AGE_TECHNOLOGIES, FIRST_AGE_WORK_PRIORITIES, INITIAL_RESOURCES, PRODUCTION_TYPES, RESOURCE_SIZE_TIERS, RESOURCE_TYPES, SPACING_ROLES, UNIT_TYPES, resourceDepletionStage } from './config.js?v=20260923-firstage1';
import { findPath } from './pathfinding.js?v=20260923-firstage1';
import { ResourceConnectivity } from './resource-connectivity.js?v=20260923-firstage1';
import { ANIMATION_EVENT_TIMINGS, ANIMATION_EVENTS, CrownforgeAnimationSystem } from './animation.js?v=20260923-firstage1';
