import {effectIcon,isDebuff} from './status-icons.js?v=20260914-bearnorune1';
export {effectIcon,isDebuff} from './status-icons.js?v=20260914-bearnorune1';
import {UNIT_TYPES} from './config.js?v=20260914-bearnorune1';
import {unitStatuses,displayedUnitHealth} from './unit-status.js?v=20260914-bearnorune1';
...
export function createCombatFrames(sim,renderer){
 const css=document.createElement('link');css.rel='stylesheet';css.href='./combat-frames.css?v=20260914-bearnorune1';document.head.append(css);
