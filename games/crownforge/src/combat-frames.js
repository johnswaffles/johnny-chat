...
import {unitStatuses,displayedUnitHealth} from './unit-status.js?v=20260914-wizardlore3';
...
export function createCombatFrames(sim,renderer){
 const css=document.createElement('link');css.rel='stylesheet';css.href='./combat-frames.css?v=20260914-wizardlore3';document.head.append(css);
