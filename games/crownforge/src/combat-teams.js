import {lastBreathTarget} from './final-benediction.js?v=20260923-teamdock1';
import {combatRadius,BEAR_FURY} from './bear-combat.js?v=20260923-teamdock1';
import {CONFIG,RESOURCE_SIZE_TIERS,UNIT_TYPES} from './config.js?v=20260923-teamdock1';
import {isWardProtected,lastCrownMercyActive} from './unit-status.js?v=20260923-teamdock1';
