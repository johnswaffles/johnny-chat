import {combatRadius,BEAR_FURY} from './bear-combat.js?v=20260921-militiasteady2';
import {CONFIG,RESOURCE_SIZE_TIERS,UNIT_TYPES} from './config.js?v=20260921-militiasteady2';
import {isWardProtected,lastCrownMercyActive} from './unit-status.js?v=20260921-militiasteady2';
