...
Bears now awaken Greatwood Colossus at 50% true health: double size and damage. This stacks with Wrath of the First Oath at 10% true health or the false Last Light reading. Shieldbearers retain 3,480 HP, 80% armor, and 5% dodge (one per twenty melee swings). Against both rages, they survive five landed hits without healing. Oathbound Stride grants three times the fastest other base movement speed. Tank damage remains 1.4. See COMBAT_EFFECTS.md for the complete balance and lore reference.

Every team Hearthkin prioritizes healing over gathering, building, or attacking until removed from the team. Every two seconds it heals all injured friendly units within 20 world units and clear line of sight, excluding itself: tanks receive 40 HP and other allies receive 20 HP. Tanks are processed first and lead the healer's following behavior. No overhealing, resurrection, or healing enemies.
...
Enemy settlement pause and player-side-only bear release remain enabled. Artwork quality is unchanged. Release revision: 20260911-bloodstorm1.
